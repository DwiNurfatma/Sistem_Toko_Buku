...
<html>
    ...
    <body>
    <header>
    <form action="beli.php" method="get" class="cari">
    ...
    while($user_data = mysqli_fetch_array($result)) {   ?>      
        ...
        <td align='center' width='100px'><a  href="chart.php?id_buku=<?php echo $user_data['id_buku']; ?>"><img src="image/search.png" height="20px"></a></td>
